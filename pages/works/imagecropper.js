...
const Work = () => (
  <Layout title="walknote">
    <Container>
      ...
      <P>
        This is a image cropper web app built with React.
        <br />
        Users have the option to zoom and rotate the image.
        <br />
        Also the user can adjust the brightness and contrast of the image and
        preview it.
      </P>
