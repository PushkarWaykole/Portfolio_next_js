  ...
  <Layout title="Works">
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section delay={0.1}>
          <WorkGridItem id="flashcard" title="Flash Card App" thumbnail={flash}>
            A Flash Card App that generates random questions and on clicking the
            card shows the answer.
          </WorkGridItem>
        </Section>
      </SimpleGrid>
    </Container>
